                                ...
                                if _>=7 :
                                    ...
                                    if temp2.faculty_tt[i][j]==temp2.faculty_tt[i][j+1]=='*' and time<temp1.lab:
                                        if temp3.sem_tt[i][j]==temp3.sem_tt[i][j+1]==temp4.classroom_tt[i][j]==temp4.classroom_tt[i][j+1]=='*' and (time+120)<=temp1.lab:
                                            ...
                                            #get the right lab
                                            while(temp6):
                                                if temp6.tt[i][j]==temp1.semester:
                                                    break
                                                temp6=temp6.next
                                            ...
                                            if tip==1 and temp5.id!=temp1.id and temp6:
                                                ...
                                                temp6.tt[i][j]+=" / "+temp1.semester
                                                temp6.tt[i][j+1]+=" / "+temp1.semester
...
def printing_leactures_time_table():
    ...
    while(temp):
            ...
            print("%-27s%-27s%-27s%-27s%-27s%-27s"%("Day","9:00-10:30","10:45-11:45","11:45-12:45","1:45-3:15","3:15-4:15"))
...
#___________________________________________________FINAL OUTPUT_______________________________________________
plotting()
plotting_for_electives()
print("************************************************************************************************************************************************************************************************************************************************************************************************************************************")
print("\n\n")
printing_students_time_table()
print("************************************************************************************************************************************************************************************************************************************************************************************************************************************")
print("\n\n")
printing_leactures_time_table()
print("************************************************************************************************************************************************************************************************************************************************************************************************************************************")
print("\n\n")
printing_students_class_rooms_table()
print("************************************************************************************************************************************************************************************************************************************************************************************************************************************")
print("\n\n")
printing_students_lab_rooms_table()

#___________________________________________________TESTING - FUNCTIONS____________________________________________________
